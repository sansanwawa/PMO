...
@Entity
@Table(name = "project_schedule_name")
public class ProjectScheduleName implements Serializable {

    @Id
    @GeneratedValue
    @Column(name = "project_schedule_name_id")
    private long id;
    @Column(name = "project_schedule_name")
    private String name;
