<%-- 
    Document   : projectScheduleList
    Created on : Mar 2, 2011, 11:19:59 AM
    Author     : sandy
--%>
<script type="text/javascript">
    ...
    Ext.onReady(function(){
        ...
        var store = new Ext.data.Store({
         ...
         var columnModel = new Ext.grid.ColumnModel({
            columns : [selectionModel,
                ...
                {header: "Schedule Name", width: 120, dataIndex: 'name', sortable: true}
        ...
        var parameterFormPanel = {
            id : 'fp',
            url :'../projectschedulename/addProcess',
            buttons: [{
                    text: 'Save',
                    handler : function(a){
                        fp.getForm().submit({
                ...
                { iconCls: 'icon-edit-button',text : "Edit",
                    handler  : function(){
                        ...
                        if(selectionLength == 0 ){
                            ...
                            fp.getForm().load({
                                method : 'GET',
                                url: '../projectschedulename/add/' + id,
                                waitMsg:'Please wait...'
                            });
                        }
                        else if(selectionLength > 1){
                    ...
                    Ext.Ajax.request({
                            url: '../projectschedulename/delete',
        ...
        function showWindow(){
            ...
            win.add(fp);
            win.setTitle('Add Project Schedule Name');
            fp.getForm().reset();
            win.doLayout(true);
            win.show();
        }
